...
//Конкотинацию мы можем заменить интерполяцией (бэктики)
...
===============================================
//Или более оптимезированый вариант
const coords = {x, y,
    calcSq() {
        console.log(this.x*this.y);
    }
...
//мы не можем помещать обьекты во внутрь наших реакт элементов
...
//Мы должны задать собственное свойство в конструкторе как бы мы делали в нативном js, в реакте создаётся свойство в виде объектаи уже из него мы вытягивает то, что нужно
...
//Если у нас пару фильтров то используем иф и элс а если мно то рациональней использовать свитч кейс которые позволяют нам делать множественные условия
