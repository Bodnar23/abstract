...
//Асинхронный код используем в тайм аутах либо при запросах на сервер
//Промисы - 
...
//     console.log(data);
// });
//Преимущество промисов перед колбэками - мы можем возвращать промисы из then по цепочке. Когда одна операция выполнится потом мы выполняем следующую и следующую
//------------------------------------------------------------------------------------------------------------------------
...
// 1) Метод all - чтобы точно убедиться что все промисы выполнились. Ждёт окончание всех промисов.
...
//Используем filter и map для получения нового массива где только люди и их имена через запятую
// const obj = {
//     nastia: 'persone',
//     egor: 'persone',
//     tofic: 'animal',
...
//Методы регулярных выражений. Относятся к срокам
...
//Метод test - возвращает правду или лож, тестирует
...
//Экранируем не числа и не буквы
...
//Методы - это то, что умеет делать объект
...
//------------------------------------------------------------------------------------------------------------------------
//Инкапсуляция - это один из принципов объектоориентированного програмирования
...
// //Второй способ для создания модуля, использования объектного интерфейса
