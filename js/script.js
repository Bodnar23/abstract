...
//Методы и свайства у строк и чисел
...
//Прототайп - при помощи него мы можем добавлять новые методы или свойства в наш конструктор и они будут проототипно наследоваться у потомков
