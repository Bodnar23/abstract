...
//------------------------------------------------------------------------------------------------------------------------
//Всплывающие окна
//Модальные окна (alert-обычное, confirm-две кнопки, prompt-окно, поле ввода и две кнопки)
...
//------------------------------------------------------------------------------------------------------------------------
//Объекы, деструктуризация обьектов
...
// console.log(arr1);
//------------------------------------------------------------------------------------------------------------------------
//Объектоорентированое програмирование
...
//метод контейнс проверяет наличие класса на значения и отвечает тру или фолс
...
//Чем рекрусивный сэттаймаут лучше чем сэтинтервал (по факту эта функция внутри сама себя вызывает)/когда таймер с интервалом работает он не учитывает как долго будет работать функция внутри него
...
//Функция - это по сути объект в который можно записать методы и свойства
...
//Второй метод - Если мы используем метод внутри объекта то контекст вызова всегда будет ссылаться на обьект/Контекст
...
//------------------------------------------------------------------------------------------------------------------------
//Принципы объекто ореинтированого програмирования
//1) обстракция - когда мы отделяем концепцию от её экземпляра
//2) наследование - способность обьекта или класса базироваться на другом объекте или классе для повторного использования кода
...
//Rest - отдельные элементы объеденяет их в один массив(...rest)
